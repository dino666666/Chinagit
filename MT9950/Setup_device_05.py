...
from device_05.BSP import AC1
from device_05.BSP import reboot
...
suite.addTests(loader.loadTestsFromTestCase(reboot.Reboot))

# 测试用例执行器
if __name__ == "__main__":
    runner = HTMLReport.TestRunner(report_file_name='device_05_'+now,  # 报告文件名，如果未赋值，将采用“test+时间戳”
